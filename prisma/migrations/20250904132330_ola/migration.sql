/*
  ...
  - You are about to drop the column `title` on the `bosses` table. All the data in the column will be lost.
  - Added the required column `name` to the `bosses` table without a default value. This is not possible if the table is not empty.
